...
Protect your WordPress login with a hidden URL, signed access tokens, IP controls, and comprehensive security hardening — without bloat.

== Description ==

**Built after hackers installed a backdoor on my WordPress site. Now it's finally quiet.**

Jacker Login Guard protects your WordPress login by hiding the entry point, enforcing short-lived HMAC-SHA256 signed access tokens, and blocking unauthorized access attempts — without slowing down your site or breaking modern authentication.
...
* **Hidden Entry URL:** Completely hides wp-login.php and wp-admin from public view.
...
* Smart Auto-Ban improvements
* Forced 2FA/Passkey (disable password login for Administrators)
* Country Blocking (GeoIP-based)
* Real-time Email Alerts
* Emergency Recovery for locked-out administrators
...
* IP Whitelist and Blacklist with IPv4/IPv6, CIDR, and range support.
...
= 1.0.0 =
Initial release. Protect your WordPress login with a hidden URL, signed access tokens, and IP controls.
...
If this plugin has saved your website from attacks or saved you hours of debugging, consider supporting the development via the link on the GitHub repository page.
